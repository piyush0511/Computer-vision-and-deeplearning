...
output1 = cv2.inpaint(image, mask, args["radius"], flags=flags1)
output2 = cv2.inpaint(image, mask, args["radius"], flags=flags2)
numpy_horizontal = np.hstack((output1, output2))
